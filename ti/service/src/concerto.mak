...
CSOURCES    := jpeg_compression.c quantization_table.c huffman_tables.c dct_matrix.c dct.c quantization.c quantization_table_reciprocal.c zigzag.c encoding.c
CPPSOURCES  := fetch_block.cpp
